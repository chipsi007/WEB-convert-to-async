...
#define CONNECTION_LED 4 // Connection LED pin (Built in)
#define AP_ENABLE_BUTTON 14 // Button pin to enable AP during startup for configuration
...
typedef struct {
	String APssid = "evak"; // ChipID is appended to this name
	String APpassword = "evakilli";
