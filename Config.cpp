...
boolean save_config() {
 ...
 DBG_OUTPUT_PORT.println("open config file open config file open config fileopen config fileopen config fileopen config fileopen config file");
